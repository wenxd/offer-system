...
/**
 * This is the model class for table "temp_payment_goods".
 *
 * @property int $id
 ...
 * @property int $is_payment 是否生成支出合同 0否 1是  采购记录列表展示是否显示
 */
class TempPaymentGoods extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function attributeLabels()
    {
        return [
            ...
            'is_payment'            => '是否生成支出合同 0否 1是  采购记录列表展示是否显示',
        ];
    }
