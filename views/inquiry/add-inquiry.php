...
<div class="box">
    ...
    <div class="box-body">
        ...
        <?php if ($is_super):?>
            <?= $form->field($model, 'goods_number')->textInput(['readonly' => true, 'maxlength' => true, 'autocomplete' => 'off'])->label('零件号') ?>
        ...
        <?php endif;?>
        <?= $form->field($model, 'goods_number_b')->textInput(['readonly' => true, 'maxlength' => true, 'autocomplete' => 'off'])->label('厂家号') ?>
