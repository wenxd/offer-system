    ...
    <div class="box-body">
        ...
        <table id="example2" class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <td><?=$competitorGoodsIssue ? $competitorGoodsIssue->quote_price : ''?></td>
                <td><?=$competitorGoodsIssue ? $competitorGoodsIssue->quote_tax_price : ''?></td>
            ...
            <tr>
                ...
                <td><?=$competitorGoodsNew ? $competitorGoodsNew->quote_price : ''?></td>
                <td><?=$competitorGoodsNew ? $competitorGoodsNew->quote_tax_price : ''?></td>
            ...
            <tr>
                ...
                <td><?=$competitorGoodsHigh ? $competitorGoodsHigh->quote_price : ''?></td>
                <td><?=$competitorGoodsHigh ? $competitorGoodsHigh->quote_tax_price : ''?></td>
            ...
            <tr>
                ...
                <td><?=$competitorGoodsLow ? $competitorGoodsLow->quote_price : ''?></td>
                <td><?=$competitorGoodsLow ? $competitorGoodsLow->quote_tax_price : ''?></td>
