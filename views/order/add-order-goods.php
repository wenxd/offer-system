...
<section class="content">
    <div class="box-body">
        <table id="example2" class="table table-striped table-bordered">
            ...
            <tr>
                <td><?= $model->id ?></td>
                <td><?= Order::$orderType[$model->order_type] ?></td>
                <td><?= $model->customer->name ?></td>
                <td><?= $model->order_sn ?></td>
                <td><?= Order::$status[$model->status] ?></td>
                <td><?= Order::$final[$model->is_final] ?></td>
            </tr>
            </tbody>
        </table>
    </div>
    <div class="box table-responsive">
        <div class="box-body">
            <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                    <td class="data" data-goods_id="<?= $goods ? $goods->id : '' ?>"
                        data-order_id="<?= $_GET['order_id'] ?? '' ?>" data-key="<?= $_GET['key'] ?? '' ?>"
            ...
            <table id="example2" class="table table-bordered table-hover">
                ...
                <tr class="inquiry_list">
                    <td><input type="radio" name="relevance" class="relevance" data-type="0"
                               data-select_id="<?= $inquiryBetter ? $inquiryBetter->id : '' ?>"></td>
                    <td>优选</td>
                    ...
                    <td class="stressColor"><b
                                class="color"><?= $inquiryBetter ? $inquiryBetter->delivery_time : 0 ?></b></td>
                    ...
                    <td>
                        <a class="btn btn-primary btn-xs btn-flat"
                           href="?r=inquiry/create&goods_id=<?= $goods ? $goods->id : '' ?>" target="_blank"><i
                                    class="fa fa-plus"></i>添加记录</a>
                    </td>
                </tr>
                <tr class="inquiry_list">
                    <td><input type="radio" name="relevance" class="relevance" data-type="0"
                               data-select_id="<?= $inquiryPrice ? $inquiryPrice->id : '' ?>"></td>
                    <td>价格</td>
                    ...
                    <td class="stressColor"><b class="color"><?= $inquiryPrice ? $inquiryPrice->delivery_time : 0 ?></b>
                    </td>
                ...
                <tr class="inquiry_list">
                    <td><input type="radio" name="relevance" class="relevance" data-type="0"
                               data-select_id="<?= $inquiryTime ? $inquiryTime->id : '' ?>"></td>
                    <td>货期</td>
                    ...
                    <td class="stressColor"><b class="color"><?= $inquiryTime ? $inquiryTime->delivery_time : 0 ?></b>
                    </td>
                ...
                <tr class="inquiry_list">
                    <td><input type="radio" name="relevance" class="relevance" data-type="0"
                               data-select_id="<?= $inquiryNew ? $inquiryNew->id : '' ?>"></td>
                    <td>最新</td>
                    ...
                    <td class="stressColor"><b class="color"><?= $inquiryNew ? $inquiryNew->delivery_time : 0 ?></b>
                    </td>
        ...
        <div class="box-footer">
            <?php if ($model->is_final) : ?>
                <?= Html::button('保存到订单 & 成本单', [
                        'class' => 'btn btn-success add_goods_save',
                        'name' => 'submit-button']
                ) ?>
            <?php else: ?>
                <?= Html::button('保存到订单', [
...
<script type="text/javascript">
    ...
    //关联询价记录
    $('.add_goods_save').click(function (e) {
        ...
        console.log({select_id: select_id, goods_id: goods_id, order_id: order_id, serial: serial, number: number});

        $.ajax({
            type:"post",
            url:'?r=order/add-order-goods',
            data:{select_id: select_id, goods_id: goods_id, order_id: order_id, serial: serial, number: number},
            dataType:'JSON',
