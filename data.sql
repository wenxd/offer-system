...
ALTER TABLE `agreement_goods` ADD INDEX idx_order_id (`order_id`);
ALTER TABLE `agreement_goods` ADD INDEX idx_order_agreement_id (`order_agreement_id`);
ALTER TABLE `agreement_goods` ADD INDEX idx_order_quote_id (`order_quote_id`);
ALTER TABLE `agreement_goods` ADD INDEX idx_goods_id (`goods_id`);
ALTER TABLE `agreement_goods_bak` ADD INDEX idx_order_agreement_id (`order_agreement_id`);
ALTER TABLE `agreement_goods_bak` ADD INDEX idx_agreement_goods_id (`agreement_goods_id`);
ALTER TABLE `agreement_stock` ADD INDEX idx_order_id (`order_id`);
ALTER TABLE `agreement_stock` ADD INDEX idx_order_agreement_id (`order_agreement_id`);
ALTER TABLE `agreement_stock` ADD INDEX idx_order_purchase_id (`order_purchase_id`);
ALTER TABLE `agreement_stock` ADD INDEX idx_order_payment_id (`order_payment_id`);
ALTER TABLE `agreement_stock` ADD INDEX idx_goods_id (`goods_id`);
ALTER TABLE `final_goods` ADD INDEX idx_order_id (`order_id`);
ALTER TABLE `final_goods` ADD INDEX idx_order_final_id (`order_final_id`);
ALTER TABLE `final_goods` ADD INDEX idx_purchase_id (`purchase_id`);
ALTER TABLE `final_goods` ADD INDEX idx_goods_id (`goods_id`);
ALTER TABLE `inquiry` ADD INDEX idx_good_id (`good_id`);
ALTER TABLE `inquiry` ADD INDEX idx_supplier_id (`supplier_id`);
ALTER TABLE `inquiry_goods` ADD INDEX idx_order_id (`order_id`);
ALTER TABLE `inquiry_goods` ADD INDEX idx_order_inquiry_id (`order_inquiry_id`);
ALTER TABLE `inquiry_goods` ADD INDEX idx_goods_id (`goods_id`);
ALTER TABLE `inquiry_temp` ADD INDEX idx_goods_id (`goods_id`);
ALTER TABLE `inquiry_temp` ADD INDEX idx_order_id (`order_id`);
ALTER TABLE `inquiry_temp` ADD INDEX idx_admin_id (`admin_id`);
ALTER TABLE `inquiry_temp` ADD INDEX idx_order_inquiry_id (`order_inquiry_id`);
ALTER TABLE `order` ADD INDEX idx_order_sn (`order_sn`);
ALTER TABLE `order` ADD INDEX idx_admin_id (`admin_id`);